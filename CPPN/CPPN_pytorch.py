# Implement CPPN using PyTorch

# Reference from - https://github.com/kwj2104/CPPN-WGAN
...
def save_image(image_data, c_dim=1):
    ...
    # Here is the figure saving directory. Change it accordingly
    # Figures are now stored in the current file directory, you can move it to Desktop or other places
    if not os.path.exists('CPPN_figures'):
        os.makedirs('CPPN_figures')

    plt.savefig('CPPN_figures/figure_'
                + str(args.cchannel) + '_'
